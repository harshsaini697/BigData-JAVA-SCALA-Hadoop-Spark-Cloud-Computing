...
static Hashtable<Point,Avg> table;
        ...
        //      private Scanner scanner;
         ...
         //                     double temp=euclidean(point1,point2);
                                ...
                                if(temp<minimum) {
                                   ...
                                   if (table.get(point3) == null)
                                	   table.put(point3,new Avg(point3.x,point3.y,1) );
                                   else table.put(point3,new Avg(table.get(point3).sumX+1,table.get(point3).sumY+1,table.get(point3).count+1 ));
//                                   try{
//                                           context.write(point3, point1);
//                                           }
